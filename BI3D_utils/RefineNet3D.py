...
from BI3D_utils.GCNet import conv3d_relu
from BI3D_utils.GCNet import deconv3d_relu
from BI3D_utils.GCNet import feature3d
...
segregnet3d(options={"regnet_out_planes": 16}, data=None) #创建一个实例
