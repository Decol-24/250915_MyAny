...
class my_runner(object):
    ...
    def train(self, train_loader, val_loader, scheduler, optimizer):
        ...
        criterion_2 = l1_loss(self.s.start_disp, self.s.end_disp, self.logger, self.s.sparse)
        ...
        for ep in range(1, self.s.train_EPOCHS + 1):
            ...
            self.train_one_epoch_amp(ep,train_loader,optimizer,criterion,criterion_2,self.s.device)
    ...
    def train_one_epoch_amp(self,ep,train_loader,optimizer,criterion,criterion_2,device):
        train_loss_1 = train_loss_2 = train_loss_3 = 0
        train_epe = 0
        self.model.train()
    ...
    def disparity_segmentation(self,start_disp, end_disp, device, step=3):
        ...
        temp.append(torch.arange(-step+1,step,step=step,device=device))
        return temp
